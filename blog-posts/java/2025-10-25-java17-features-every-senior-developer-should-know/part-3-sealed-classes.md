...
- **← [Part 2: Records](./part-2-records.md)** - Modern data carriers
- **← [Series Overview](./README.md)** - Overview and series guide
- **→ [Part 4: Pattern Matching & Switch](./part-4-pattern-matching-and-switch.md)** - Next: Modern pattern matching
