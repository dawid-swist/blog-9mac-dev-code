...
- **← [Part 1: Introduction & var](./part-1-introduction-and-var.md)** - Local variable type inference
- **← [Series Overview](./README.md)** - Overview and series guide
- **→ [Part 3: Sealed Classes](./part-3-sealed-classes.md)** - Next: Controlled inheritance
